    ...
    <div class="col-9">
      <table class="table table-hover">
        ...
        ?>
          <tbody>
            <tr>
              <td data-label="Fecha Orden "> <?php echo $op['FechaOrden']; ?> </td>
              <td data-label="Documento Empleado"> <?php echo $op['DocumentoEmpleado']; ?> </td>
              <td data-label="Nombre empleado"> <?php echo $op['NombreEmpleado']; ?> </td>
              <td data-label="Cantidad usada"> <?php echo $op['CantidadUsadas']; ?> </td>
              <td data-label="Codigo receta"> <?php echo $op['CodigoReceta']; ?> </td>
              <td data-label="Producto receta"> <?php echo $op['ProductoReceta']; ?> </td>
            </tr>
          </tbody>
        <?php
        endforeach;
